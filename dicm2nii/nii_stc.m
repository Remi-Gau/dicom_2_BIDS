function varargout = nii_stc(in, out, timing)
    ...
    try
        ...
        switch nii.hdr.slice_code
            case 1                                % ascending
            case 2
                t(nSL:-1:1) = t;              % descending
            case 3
                t([1:2:nSL 2:2:nSL]) = t;     % interleaved ascending, start 1
            case 4
                t([nSL:-2:1 nSL - 1:-2:1]) = t; % interleaved descending, start n
            case 5
                t([2:2:nSL 1:2:nSL]) = t;     % interleaved ascending, start 2
            case 6
                t([nSL - 1:-2:1 nSL:-2:1]) = t; % interleaved descending, start n-1
            otherwise
                t = [];
        end
    end
