...
elseif t1(1) == t1(2), sc = 7; t1 = unique(t1); % made-up code 7 for MB
...
if isempty(nFrame), nFrame = numel(s.(pffgs).FrameStart); end
...
try
    ...
    if isempty(latestStr), error('Date info not found'); end
